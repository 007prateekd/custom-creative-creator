...
def align_face(filepath, output_size=1024, transform_size=4096, enable_padding=True):
    ...
    :return: PIL Image
    """
    ensure_checkpoint_exists("JoJo_GAN/models/dlibshape_predictor_68_face_landmarks.dat")
    predictor = dlib.shape_predictor("JoJo_GAN/models/dlibshape_predictor_68_face_landmarks.dat")
